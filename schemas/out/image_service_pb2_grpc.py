...
class ImageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetImage = channel.unary_stream(
                ...
                response_deserializer=image__service__pb2.GetImageReply.FromString,
...
def add_ImageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetImage': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=image__service__pb2.GetImageReply.SerializeToString,
            ),
    }
...
class ImageService(object):
    ...
    def GetImage(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            image__service__pb2.GetImageReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
